  ...
  return (
    <>
      ...
      <Section className="pt-32 pb-16">
        ...
        >
          <motion.h1 variants={fadeInUp} className="text-5xl md:text-7xl mb-8 text-directors-crimson">
            The Story Behind the Story
          </motion.h1>
          <motion.p variants={fadeInUp} className="text-xl md:text-2xl text-espresso-black/70 font-serif italic">
      ...
      <Section className="bg-white">
        <div className="grid md:grid-cols-12 gap-12">
          <div className="md:col-span-8 md:col-start-3 space-y-8 text-lg leading-relaxed text-espresso-black/80">
            <p>
            ...
            <h3 className="text-2xl text-directors-crimson font-serif pt-8">The Pivotal Moment</h3>
            <p>
      ...
      {/* The Journey */}
      <Section dark className="bg-olive-umber">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-1 md:order-2 space-y-6 text-textured-vellum/90 leading-relaxed">
            <h2 className="text-3xl md:text-4xl text-textured-vellum mb-6">The Journey</h2>
            <p>
      ...
      <Section>
        <div className="max-w-3xl mx-auto space-y-12">
          <div>
            <h2 className="text-3xl md:text-4xl text-directors-crimson mb-6">The Realisation</h2>
            <p className="text-lg text-espresso-black/80 leading-relaxed">
          ...
          <div className="h-px bg-espresso-black/10 w-full" />

          <div>
            <h2 className="text-3xl md:text-4xl text-directors-crimson mb-6">What I Bring Now</h2>
            <p className="text-lg text-espresso-black/80 leading-relaxed mb-6">
      ...
      <Section className="bg-terracotta-sand/10">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-serif text-directors-crimson mb-8">Off The Page</h2>
          <p className="text-lg text-espresso-black/80 leading-relaxed mb-12">
