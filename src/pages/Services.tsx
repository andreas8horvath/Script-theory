...
const Services = () => {
  return (
    <>
      {/* Header */}
      <Section className="pt-32 pb-16 bg-deep-teal text-warm-ivory">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl md:text-7xl mb-8">Depth & Craft</h1>
          <p className="text-xl md:text-2xl text-warm-ivory/80 font-light leading-relaxed">
      ...
      <Section id="courses">
        <div className="max-w-5xl mx-auto">
          <div className="mb-12">
            ...
            <h2 className="text-4xl md:text-5xl text-deep-teal mt-2 mb-4">Holistic Screenwriting Courses</h2>
            <p className="text-xl text-charcoal/60 italic font-serif">For writers ready to build or rebuild their craft from the ground up</p>
          </div>

          <div className="grid md:grid-cols-2 gap-12 mb-12">
            <div>
              <h3 className="text-xl font-bold text-deep-teal mb-4">Who This Is For</h3>
            ...
            <div>
              <h3 className="text-xl font-bold text-deep-teal mb-4">What’s Included</h3>
              <ul className="space-y-2">
                {[
                  ...
                  <li key={i} className="flex items-start text-charcoal/80">
                    <Check size={16} className="text-forest-green mt-1 mr-3 flex-shrink-0" />
                    <span>{item}</span>
                  </li>
                ))}
              </ul>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white p-8 border border-charcoal/10 shadow-sm">
              <h4 className="text-2xl font-serif text-deep-teal mb-2">6-Month Course</h4>
              <p className="text-3xl font-light mb-6">€1,799 <span className="text-sm text-charcoal/50 block">or €200/month</span></p>
              <p className="text-charcoal/70 mb-8 text-sm">Develops innate skills from the ground up. Perfect for writers who want a rigorous, supported introduction to holistic screenwriting.</p>
              <Button to="/contact" variant="outline" className="w-full">Inquire Now</Button>
            </div>
            <div className="bg-deep-teal text-warm-ivory p-8 shadow-md relative overflow-hidden">
              <div className="absolute top-0 right-0 bg-burnt-amber text-xs font-bold px-3 py-1 uppercase tracking-widest">Popular</div>
              ...
              <Button to="/contact" variant="primary" className="w-full bg-white text-deep-teal hover:bg-burnt-amber hover:text-white">Inquire Now</Button>
            </div>
          </div>
        </div>
      </Section>
      ...
      <Section className="bg-muted-clay/10" id="consultations">
        <div className="max-w-5xl mx-auto">
          <div className="mb-12">
            ...
            <h2 className="text-4xl md:text-5xl text-deep-teal mt-2 mb-4">Script Consultations</h2>
            <p className="text-xl text-charcoal/60 italic font-serif">For writers with a screenplay that needs expert analysis and a clear path forward</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-white p-8 border-t-4 border-deep-teal shadow-sm hover:shadow-lg transition-shadow">
                <h4 className="text-xl font-serif text-deep-teal mb-1">{pkg.name}</h4>
                <span className="text-xs uppercase tracking-widest text-slate mb-4 block">{pkg.duration}</span>
                <p className="text-3xl font-light mb-6">{pkg.price}</p>
                <p className="text-charcoal/70 mb-8 text-sm leading-relaxed">{pkg.desc}</p>
      ...
      <Section>
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-16">
          ...
          <div id="hire">
            ...
            <p className="text-sm text-slate mb-6">Pricing is project-based (minimum 2% of production budget).</p>
            <Button to="/contact" variant="text" className="text-deep-teal">Contact to Discuss</Button>
          </div>
        </div>
      </Section>
      ...
      {/* FAQ */}
      <Section className="bg-warm-ivory border-t border-charcoal/5">
        <FAQ />
      </Section>

      {/* CTA */}
      <Section className="text-center bg-deep-teal text-warm-ivory">
        <h2 className="text-4xl md:text-5xl mb-8">Ready to Go Deeper?</h2>
        <p className="text-xl text-warm-ivory/80 mb-12 max-w-2xl mx-auto">
        ...
        <Button to="/contact" variant="primary" className="bg-burnt-amber hover:bg-white hover:text-deep-teal">Book Your Discovery Call</Button>
      </Section>
    </>
  );
};
